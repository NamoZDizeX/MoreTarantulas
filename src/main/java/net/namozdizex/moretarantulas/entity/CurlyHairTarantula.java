...
public class CurlyHairTarantula extends Monster {
    ...
    public CurlyHairTarantula(EntityType<? extends CurlyHairTarantula> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new CurlyHairTarantula.TarantulaAttackGoal(this, Player.class));
        this.goalSelector.addGoal(5, new WaterAvoidingRandomStrollGoal(this, 0.8));
        this.goalSelector.addGoal(6, new LookAtPlayerGoal(this, Player.class, 8.0F));
        this.goalSelector.addGoal(6, new RandomLookAroundGoal(this));
        this.targetSelector.addGoal(1, new HurtByTargetGoal(this, new Class[0]));
        this.targetSelector.addGoal(2, new CurlyHairTarantula.TarantulaAttackGoal(this, Player.class));
    }
    ...
    static class TarantulaAttackGoal extends MeleeAttackGoal {
        public TarantulaAttackGoal(CurlyHairTarantula spider, Class<Player> playerClass) {
