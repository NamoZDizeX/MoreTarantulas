...
public class GoldenKneeTarantula extends Monster {
    private static EntityDataAccessor<Byte> DATA_FLAGS_ID = null;
    public GoldenKneeTarantula(EntityType<? extends GoldenKneeTarantula> entityType, Level level) {
        super(entityType, level);
    }
    protected void registerGoals() {
        this.goalSelector.addGoal(1, new FloatGoal(this));
        this.goalSelector.addGoal(3, new LeapAtTargetGoal(this, 0.4F));
        this.goalSelector.addGoal(4, new GoldenKneeTarantula.TarantulaAttackGoal(this, Player.class));
        this.goalSelector.addGoal(5, new WaterAvoidingRandomStrollGoal(this, 0.8));
        this.goalSelector.addGoal(6, new LookAtPlayerGoal(this, Player.class, 8.0F));
        this.goalSelector.addGoal(6, new RandomLookAroundGoal(this));
        this.targetSelector.addGoal(1, new HurtByTargetGoal(this, new Class[0]));
        this.targetSelector.addGoal(2, new GoldenKneeTarantula.TarantulaAttackGoal(this, Player.class));
    }
    ...
    static class TarantulaAttackGoal extends MeleeAttackGoal {
        public TarantulaAttackGoal(GoldenKneeTarantula spider, Class<Player> playerClass) {
