...
public class PterinochilusMurinusTarantula extends Monster {
    private static EntityDataAccessor<Byte> DATA_FLAGS_ID = null;
    public PterinochilusMurinusTarantula(EntityType<? extends PterinochilusMurinusTarantula> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new PterinochilusMurinusTarantula.TarantulaAttackGoal(this, Player.class));
        this.goalSelector.addGoal(5, new WaterAvoidingRandomStrollGoal(this, 0.8));
        this.goalSelector.addGoal(6, new LookAtPlayerGoal(this, Player.class, 8.0F));
        this.goalSelector.addGoal(6, new RandomLookAroundGoal(this));
        this.targetSelector.addGoal(1, new HurtByTargetGoal(this, new Class[0]));
        this.targetSelector.addGoal(2, new PterinochilusMurinusTarantula.TarantulaAttackGoal(this, Player.class));
    }
    ...
    static class TarantulaAttackGoal extends MeleeAttackGoal {
        public TarantulaAttackGoal(PterinochilusMurinusTarantula spider, Class<Player> playerClass) {
