...
public class MTItems {
    ...
    public static final Item TAKSINUS_BAMBUS_SPAWN_EGG = new SpawnEggItem(MTEntity.TAKSINUS_BAMBUS_TARANTULA, 0x1f1f20 ,0xfcd802, new Item.Properties().tab(MoreTarantulasMod.TAB));
